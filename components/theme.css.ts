...
export const themeClass = createTheme(themeContract, {
  ...
  color: {
    backgroundColor: '#FFF',
    onBackgroundColor: 'forestgreen',
    onBackgroundHoverColor: 'green',
    primaryColor: '#6C5CE7',
    onPrimaryColor: 'purple',
    onPrimaryHoverColor: 'pink',
    onPrimaryDisabled: 'gray',
    borderPrimaryColor: '#6C5CE7',
    borderPrimaryHoverColor: '#8376EB',
...
export const otherThemeClass = createTheme(themeContract, {
  ...
  color: {
    backgroundColor: '#FFF',
    onBackgroundColor: 'cadetblue',
    onBackgroundHoverColor: 'turquoise',
    primaryColor: 'orange',
    onPrimaryColor: 'darkorange',
    onPrimaryHoverColor: 'gold',
    onPrimaryDisabled: 'gray',
